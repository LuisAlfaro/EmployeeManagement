...
@Component({
  selector: 'app-list-employee-shop',
  templateUrl: './list-employee-shop.component.html',
  styleUrls: ['./list-employee-shop.component.css']
})
export class ListEmployeeShopComponent {
  displayedColumns: string[] = ['name', 'salary'];
